...
import { callContractMethodController, executeContractMethodController, getTokensOfWallet, createLocation } from "../controllers/contract.controller";
...
app.post("/createPoAPCollection", async (req: Request, res: Response) => {
  const requestMade: string = `POST /createPoAPCollection`;
  ...
  await handleControllerCall(req, res, logger, createLocation);
});
